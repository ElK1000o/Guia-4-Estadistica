...
En este trabajo utilizaremos los datos de la encuesta CEP 85 (estudio nacional de opinion publica N°55, tercera serie, agosto 2021), realizada por el Centro de Estudios Publicos (CEP), la cual hace un analisis que busca medir principalmente los siguientes temas; Percepciones politicas y economicas, democracia y confianza, vision del pais y principales problemas, democracia y confianza y identificacion politica y nivel de politizacion.

En este trabjo utilizaremos los datos de la encuesta cep 85 (estudio nacional de opinión pública, tercera serie N°55, agosto 2021), la cual hace un analisis que busca medir principalmente los siguientes temas;
...
El atributo que bsca representar esta variable es la identidad politica de las personas 
